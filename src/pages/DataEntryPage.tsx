...
const DataEntryPage = () => {
  ...
  const formSchema = z.object({
    ...
    invoiceNumber: z.string().min(1, "Invoice number is required (رقم الفاتورة مطلوب)"),
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        {/* Document viewer - 60% width on large screens */}
        ...
        {/* Data entry form - 40% width on large screens */}
